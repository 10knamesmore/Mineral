...
use crate::schema::{
    ...
    MenuReveal, MineralSection, NeteaseSection, PrefetchConfig, PulseConfig, PulseDepthConfig,
    PunchConfig, QueueConfig, QueueTransform, ReportConfig, RevealConfig, RotateConfig,
