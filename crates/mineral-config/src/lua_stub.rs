...
use crate::schema::{
    ...
    MenuReveal, MineralSection, MinimapConfig, NeteaseSection, PlaylistFetchSection,
    PrefetchConfig, PulseConfig, PulseDepthConfig, PunchConfig, QueueConfig, QueueTransform,
    ReportConfig, RevealConfig, RotateConfig, ScopeConfig, ScriptConfig, SearchConfig,
