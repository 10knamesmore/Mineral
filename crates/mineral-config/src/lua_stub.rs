...
use crate::schema::{
    ...
    CoverProtocolMode, CoverTransitionConfig, CoverTransitionStyle, DaemonConfig, DeepSearchConfig,
    DeepWeights, DownloadConfig, DriftConfig, DynamicThemeConfig, EnvelopeConfig, FilterPlayScope,
    FsSpectrumConfig, HighpassConfig, KeysConfig, KmeansConfig, LayoutConfig, LyricsConfig,
    ...
    QueueTransform, ReportConfig, RevealConfig, RotateConfig, ScopeConfig, ScriptConfig,
