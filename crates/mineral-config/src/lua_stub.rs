...
use crate::schema::{
    ...
    LayoutConfig, LyricsConfig, MarqueeBounceConfig, MarqueeConfig, MarqueeLoopConfig, MarqueeMode,
    MenuReveal, MineralSection, MinimapConfig, NeteaseSection, PrefetchConfig, PulseConfig,
    PulseDepthConfig, PunchConfig, QueueConfig, QueueTransform, ReportConfig, RevealConfig,
    RotateConfig, ScopeConfig, ScriptConfig, SearchConfig, SearchFocusTransition, SearchHitConfig,
    ...
    TitleIcons, ToastConfig, TrackPosMemory, TrailTimingConfig, TuiConfig, VignetteConfig,
